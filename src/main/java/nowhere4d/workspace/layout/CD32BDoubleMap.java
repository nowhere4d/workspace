...
public class CD32BDoubleMap extends CDAbstractMap implements Serializable
{
	//=========================================================================
	// 생성자
	//-------------------------------------------------------------------------
	 ...
	 * 
	 */
	private static final long serialVersionUID = 475402440310152655L;

	public CD32BDoubleMap()
	{
		this(DEFAULT_CAPACITY);
	}

	public CD32BDoubleMap(int initialCapacity)
	{
		this(initialCapacity, DEFAULT_MIN_LOAD_FACTOR, DEFAULT_MAX_LOAD_FACTOR);
	}

	public CD32BDoubleMap(int initialCapacity, double minLoadFactor, double maxLoadFactor)
	{
	...
	public int[] getKeys()
	{
		int[] keyArray = new int[m_distinct];
	...
	@Override
	public CD32BDoubleMap clone()
	{
		CD32BDoubleMap copy = new CD32BDoubleMap();
	...
	protected void rehash(int newCapacity)
	{
		...
		for (int index = oldKeys.length; index-- > 0;)
		{
			...
			{
				// 이전 값을 가져온다.
				final int oldKey = oldKeys[index];
