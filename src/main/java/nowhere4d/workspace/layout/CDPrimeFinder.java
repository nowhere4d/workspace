...
public class CDPrimeFinder extends Object
{
	//=========================================================================
	// 생성자 
	//-------------------------------------------------------------------------
	...
	/**************************************************************************
	 * 다른 클래스에서 상속받을 수 없도록 PRIVATE 메소드로 생성자를 설정한다. 
	 **************************************************************************/
	private CDPrimeFinder() {}
	...
	/**************************************************************************
	 * 해쉬 테이블의 용량을 정하기 위해 값을 구한다. 구하는 값은 사용자가 요구하는 <BR>
	 * 용량 보다 크거나 같은 근접한 소수를 사용한다.<BR>
	 * (within 11% if <code>desiredCapacity &gt;= 1000</code>).
	 * 
	 * @param  desiredCapacity 사용자가 요구하는 용량
	 * @return 적당한 소수 값
	 **************************************************************************/
	public static int nextPrime(int desiredCapacity)
	{
		// 소수 집합이 정렬되어 있으므로 바이너리 검색을 통해 적당한 소수를 찾아낸다. 
		int index = java.util.Arrays.binarySearch(primeCapacities, desiredCapacity);

		// 소수를 발견하지 못하면, desiredCapacity 값보다 큰 다음 소수를 선택한다.
		if (index < 0)
			index = -index - 1;
	...
	/**************************************************************************
	 * 찾을 수 있는 가장 큰 소수는 Integer.MAX_VALUE 이다. 2^31 - 1 은 실제로 소수다.
	 **************************************************************************/
	...
	/**************************************************************************
	 * 위에 나열된 소수들은 사람이 보기 좋은 형태로 구성되어져 있다.
	 * 숫자를 찾을 때 빨리 찾으려면 미리 정렬된 상태로 있어야 하므로 컴파일 시점에서 정렬을 해준다.
	 **************************************************************************/
	static
	{	
